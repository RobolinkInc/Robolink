...
#ifdef Servo_h	//defined
//#if defined(_useTimer3)	//not defined
//#define AVAILABLE_TONE_PINS 1
#define USE_TIMER3
...
/*///////////////////////////////////////////////////////////////////*/
//atmega128
      #if defined(TCCR3A) && defined(TCCR3B) &&  defined(ETIMSK)
        // 16 bit timer
        TCCR3A = 0;
        TCCR3B = 0;
        bitWrite(TCCR3B, WGM32, 1);
